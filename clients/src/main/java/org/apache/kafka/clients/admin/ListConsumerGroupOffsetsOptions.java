...
public class ListConsumerGroupOffsetsOptions extends AbstractOptions<ListConsumerGroupOffsetsOptions> {
    ...
    /**
     * Value to specify for topic partition list in {@link #topicPartitions(List)} and the map in
     * {@link Admin#listConsumerGroupOffsets(java.util.Map, ListConsumerGroupOffsetsOptions)} to
     * list offsets for all partitions.
     */
    public static final List<TopicPartition> ALL_TOPIC_PARTITIONS = null;

    private List<TopicPartition> topicPartitions = ALL_TOPIC_PARTITIONS;
